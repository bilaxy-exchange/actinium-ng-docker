...
&& apt-get -y install libboost-all-dev libdb4.8 libdb4.8++ libssl1.0.0 unzip \
libevent-2.1-6 libevent-pthreads-2.1-6 software-properties-common \
git build-essential libtool pkg-config autotools-dev automake \
libcap-dev libseccomp-dev zlib1g-dev wget libzmq5 libminiupnpc10 \
